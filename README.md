...
12 weeks · 50 minutes/day

| Phase | Weeks | Scope |
|---|---|---|
| 0 | Pre | Finish Next.js docs, repo setup, domain |
| 1 | 1–2 | UI shell — layout, navbar, homepage, product grid, detail, search, filters |
| 2 | 3–5 | Auth, cart, wishlist, reviews, Stripe checkout |
| 3 | 6–8 | PostgreSQL + Prisma — schema, seed, server actions, real search |
| 4 | 9–12 | Admin, AI chat, Framer Motion, Lighthouse polish, README, demo |
