  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed top-0 right-0 z-[60] h-full w-full md:w-[420px] bg-[#111010] border-l border-[#1E1C18] flex flex-col transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        {items.length > 0 && (
          <>
            <ul className="flex-1 overflow-y-auto divide-y divide-[#1E1C18]">
              {items.map((item) => (
                <li
                ...
                >
                  ...
                  <Link
                    ...
                    onClick={onClose}
                    className="relative w-20 aspect-[3/4] bg-[#1E1C18] shrink-0 overflow-hidden"
                  >
                    <Image
                      src={item.image}
                      alt={item.name}
                  ...
                  <div className="flex flex-col justify-between flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      {/* Quantity control */}
                      <div className="flex items-center gap-3 border border-[#3A3830]">
                        <button
                          onClick={() =>
                            updateQuantity(
                              item.productId,
                        ...
                        <span className="text-[#E8E4DE] text-sm w-4 text-center">
                          {item.quantity}
                        </span>
                        <button
                          onClick={() =>
                  ...
                  <button
                    ...
                    className="text-[#3A3830] hover:text-[#7A7468] transition-colors self-start mt-1"
                  >
